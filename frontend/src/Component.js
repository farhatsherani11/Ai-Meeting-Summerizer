                                ...
                                <details className="group">
                                    <summary className="flex items-center space-x-2 cursor-pointer outline-none">
                                        <div className="w-10 h-10 rounded-full bg-primary-700 flex items-center justify-center border-2 border-primary-500 overflow-hidden">
                                            <img
                                                src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHwxfHx1c2VyfGVufDB8fHx8MTc1MzI5MjczOXww&ixlib=rb-4.1.0&q=80&w=1080"
                                                alt="User profile"
                                    ...
                                    <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 shadow-lg rounded-md py-1 z-10">
                                        ...
                                        <a
                                            href="#logout"
                                            className="block px-4 py-2 text-red-400 hover:bg-gray-700 transition-colors"
                                        >
                                            Log out
                                        </a>
                                    </div>
                            ...
                            <div className="bg-gray-800 rounded-lg shadow-lg p-5 sticky top-5">
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div
                                            key={index}
                                            className={`p-3 rounded-md cursor-pointer transition-all hover:bg-gray-700 ${index === 0 ? "bg-gray-700" : "bg-gray-800"}`}
                                        >
                                    ...
                                    <div className="bg-gray-700 p-4 rounded-md">
                                        ...
                                        <div className="flex -space-x-2 overflow-hidden">
                                            <img
                                                ...
                                                src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHwyfHx1c2VyfGVufDB8fHx8MTc1MzI5MjczOXww&ixlib=rb-4.1.0&q=80&w=1080"
                                                alt="User"
                                                keywords="user, profile, avatar, participant"
                                            />
                                            <img
                                                className="w-8 h-8 rounded-full border-2 border-gray-700"
                                                src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHwzfHx1c2VyfGVufDB8fHx8MTc1MzI5MjczOXww&ixlib=rb-4.1.0&q=80&w=1080"
                                                alt="User"
                                                keywords="user, profile, avatar, participant"
                                            />
                                            <img
                                                className="w-8 h-8 rounded-full border-2 border-gray-700"
                                                src="https://images.unsplash.com/photo-1639149888905-fb39731f2e6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHw0fHx1c2VyfGVufDB8fHx8MTc1MzI5MjczOXww&ixlib=rb-4.1.0&q=80&w=1080"
                                                alt="User"
                                                keywords="user, profile, avatar, participant"
                                            />
                                            <img
                                                className="w-8 h-8 rounded-full border-2 border-gray-700"
                                                src="https://images.unsplash.com/photo-1640951613773-54706e06851d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3MzkyNDZ8MHwxfHNlYXJjaHw1fHx1c2VyfGVufDB8fHx8MTc1MzI5MjczOXww&ixlib=rb-4.1.0&q=80&w=1080"
                                                alt="User"
                                                keywords="user, profile, avatar, participant"
                                            />
                                    ...
                                    <div className="bg-gray-700 p-4 rounded-md">
                                        ...
                                        <div className="flex items-center">
                                            <img
                                                ...
                                                src="https://img.icons8.com/color/48/000000/zoom.png"
                                                alt="Zoom"
                                                keywords="zoom, meeting, platform, video call"
                                            />
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="bg-gray-700 p-5 rounded-md">
                                        <p className="text-gray-300 mb-3">
                                            The team discussed progress on the new dashboard feature. Key highlights:
                                        </p>
                                        <ul className="list-disc pl-5 space-y-2 text-gray-300">
                                            <li>
                                                Backend API integration is 80% complete; Sarah will finish by Thursday.
                                            </li>
                                            <li>UI design reviews are complete with minor changes requested.</li>
                                            <li>
                                                QA team needs more detailed test cases; Michael will provide by EOD.
                                            </li>
                                            ...
                                            {[
                                                {
                                                    ...
                                                    time: "00:01:22",
                                                    content:
                                                        "Let's start with updates on the dashboard feature. Sarah, can you share your progress?"
                                                },
                                                {
                                                    speaker: "Sarah",
                                                    time: "00:01:45",
                                                    content:
                                                        "I've completed about 80% of the API integration. There were a few unexpected issues with data formatting, but I've resolved most of them. I should be able to finish everything by Thursday."
                                                },
                                                {
                                                    speaker: "John (Host)",
                                                    time: "00:02:30",
                                                    content: "That sounds good. Any blockers we should be aware of?"
                                                },
                                                {
                                                    speaker: "Sarah",
                                                    time: "00:02:38",
                                                    content:
                                                        "Not at the moment. The documentation from the backend team was very helpful."
                                                },
                                                {
                                                    speaker: "Michael",
                                                    time: "00:03:15",
                                                    content:
                                                        "I wanted to mention that we'll need more detailed test cases for QA. The current ones don't cover all edge cases."
                                                },
                                                {
                                                    speaker: "John (Host)",
                                                    time: "00:03:45",
                                                    content: "Can you prepare those by end of day, Michael?"
                                                },
                                                {
                                                    speaker: "Michael",
                                                    time: "00:03:52",
                                                    content: "Yes, I'll take care of it."
                                                }
                                            ].map((entry, index) => (
                            ...
                            <div className="bg-gray-800 rounded-lg shadow-lg p-6">
                                ...
                                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            className="w-full bg-gray-700 border border-gray-600 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
